{{-- CSS untuk Floating Button (Sudah dimodifikasi untuk SVG) --}}
<style>
.whatsapp-float-btn {
  position: fixed;
  width: 60px;
  ...
  z-index: 1000; /* Memastikan tombol di atas konten lain */

  /* Menggunakan Flexbox untuk menengahkan ikon SVG */
  display: flex;
  align-items: center;
...
{{-- Tombol WhatsApp (Menggunakan SVG) --}}
<a
  href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20bertanya%20sesuatu."
